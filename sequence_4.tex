...
\section{Signal continu - Aspect fréquentiel}
...
\end{itemize}
Vous procèderez par identification des différents triplets de chacun des signaux.
\end{exampleblock}
\end{frame}
...
\justifying Retrouver le résultat de l'exercice IV de la séquence précédente par le calcul de
$S(k)$ sur le signal carré :
\begin{figure}
% 	\psset{xunit=1cm}
% 	\psset{yunit=1cm}
