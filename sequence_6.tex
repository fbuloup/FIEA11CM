...
\begin{frame}
\begin{exampleblock}{Exercice \Roman{exampleBlockCounter} - Filtrage de la note - Étape 1}
\begin{enumerate}
...
\begin{frame}
\begin{exampleblock}{Exercice \Roman{exampleBlockCounter} - Filtrage de la note - Étape 2}
